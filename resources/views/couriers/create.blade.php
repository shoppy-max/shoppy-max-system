<x-app-layout>
    <x-form-layout>
        <div class="mb-6">
            ...
            <h2 class="mt-4 text-2xl font-bold text-gray-900 dark:text-white">Add New Courier</h2>
        </div>
