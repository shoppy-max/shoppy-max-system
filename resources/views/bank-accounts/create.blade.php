<x-app-layout>
    <x-form-layout>
        <div class="mb-6">
            ...
            <h2 class="mt-4 text-2xl font-bold text-gray-900 dark:text-white">Add Bank Account</h2>
        </div>
        ...
        <form action="{{ route('bank-accounts.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 space-y-6">
                    <x-form-section title="Account Details" description="Add the payment account details used for courier reconciliation.">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="e.g. Courier Settlement - Main" required>
                            ...
                            <div>
                                ...
                                <select name="type" id="type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    @foreach(['Bank', 'Mobile Wallet', 'Cash', 'Other'] as $type)
                                        <option value="{{ $type }}" {{ old('type', 'Bank') === $type ? 'selected' : '' }}>{{ $type }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="e.g. Commercial Bank">
                            ...
                            <div>
                                ...
                                <input type="text" name="account_number" id="account_number" value="{{ old('account_number') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="e.g. 1234567890">
                            ...
                            <div>
                                ...
                                <input type="text" name="holder_name" id="holder_name" value="{{ old('holder_name') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="e.g. Shoppy Max Pvt Ltd">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="note" id="note" rows="3" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Optional note for internal use.">{{ old('note') }}</textarea>
                ...
                <div class="space-y-6">
                    <x-form-section title="Status">
                        <div class="space-y-4">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400">Inactive accounts are hidden from the Receive Courier Payment screen.</p>
                        </div>
                    </x-form-section>
