                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                         <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Direct User Payments</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-gray-800" x-data="{ selected: [], allSelected: false, toggleAll() { this.allSelected = !this.allSelected; if(this.allSelected) { this.selected = [{{ $payments->pluck('id')->implode(',') }}]; } else { this.selected = []; } } }">
        ...
        <div class="flex flex-col space-y-4 lg:flex-row lg:items-start lg:justify-between lg:space-y-0 lg:space-x-4 mb-6">
            ...
            <div class="flex flex-wrap items-center gap-2 lg:flex-nowrap lg:justify-end">
                @can('import direct reseller payments')
                ...
                <!-- Bulk Download Form -->
                @can('download direct reseller payments')
                ...
                @can('create direct reseller payments')
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                @endcan
                                @can('edit direct reseller payments')
                                ...
                                @endcan
                                @can('cancel direct reseller payments')
                                <form action="{{ route('reseller-payments.cancel', $payment->id) }}" method="POST" data-confirm-message="Are you sure you want to cancel this payment? This will reverse the amount from the reseller due.">
                                    @csrf
