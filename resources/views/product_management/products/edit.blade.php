                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" value="{{ old('name', $product->name) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="e.g. Product Name" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="text" id="sku" name="sku" value="{{ old('sku', $product->sku) }}" class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <div class="flex justify-between items-center mb-2">
                                            <label for="category_id" class="block text-sm font-medium text-gray-900 dark:text-white">Category</label>
                                    ...
                                    <div class="flex justify-between items-center mb-2">
                                     ...
                                     <select id="unit_id" name="unit_id" x-model="selectedUnit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        ...
                                        <template x-for="u in newUnits" :key="u.id">
                                            <option :value="u.id" x-text="u.name + ' (' + u.short_name + ')'" :selected="u.id == selectedUnit"></option>
                                        </template>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400" id="file_input_help">Leave blank to keep current image. SVG, PNG, JPG or GIF (MAX. 2MB).</p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" step="0.01" id="selling_price" name="selling_price" value="{{ old('selling_price', $product->selling_price) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0.00" required>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" step="0.01" id="limit_price" name="limit_price" value="{{ old('limit_price', $product->limit_price) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0.00">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="alert_quantity" name="alert_quantity" value="{{ old('alert_quantity', $product->alert_quantity) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-100 dark:border-blue-800">
                                    ...
                                    <div class="relative">
                                        <input type="text" value="{{ $product->quantity }}" disabled class="bg-gray-200 border border-gray-300 text-gray-500 text-sm rounded-lg cursor-not-allowed block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-gray-400">
                                    ...
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
                                        ...
                                        To modify stock, create a new Purchase or Adjustment.
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        function productForm() {
            return {
                ...
                selectedUnit: '{{ old('unit_id', $product->unit_id) }}',
                newCategories: [],
                newSubCategories: [],
                newUnits: [],
                errorMessage: '',
