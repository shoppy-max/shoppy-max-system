                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="flex-shrink-0 w-10 h-10">
                                        @if($product->image_url)
                                            <img class="w-10 h-10 rounded-full object-cover" src="{{ $product->image_url }}" alt="{{ $product->name }}">
                                        @else
                        ...
                        <div class="flex gap-4 mb-4">
                            <div class="flex-shrink-0">
                                <template x-if="activeProduct?.image_url">
                                    <img :src="activeProduct.image_url" class="w-20 h-20 rounded-lg object-cover bg-gray-100" />
                                </template>
                                <template x-if="!activeProduct?.image_url">
