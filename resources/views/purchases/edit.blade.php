            ...
            <!-- Basic Info Card -->
                <div class="p-6 bg-white rounded-lg shadow dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Supplier -->
                        <div x-data="{ 
                            supplierSearch: '{{ $purchase->supplier->business_name ?? $purchase->supplier->name }}', 
                            supplierOpen: false, 
                            selectedSupplier: { id: {{ $purchase->supplier_id }}, name: '{{ $purchase->supplier->business_name ?? $purchase->supplier->name }}' },
    ...
    <script>
        function purchaseForm() {
            return {
                ...
                payments: {!! json_encode(json_decode($purchase->payments_data ?? '[]')) !!} || [],
