                ...
                <form method="GET" action="{{ route('purchases.index') }}" class="w-full space-y-3 xl:flex-1">
                    <div class="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-12">
                        <div class="relative xl:col-span-6">
                            ...
                            <input type="search" name="search" value="{{ request('search') }}" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white" placeholder="Search by reference or supplier">
                        </div>
