        ...
        <form action="{{ route('resellers.update', $reseller) }}" method="POST" x-data="resellerForm()">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <x-form-section title="Return Fee" description="Penalty amount deducted from reseller balance when an assigned order is marked Returned.">
                        <div>
                            <label for="return_fee" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Return Fee <span class="text-red-500">*</span></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                    <span class="text-gray-500 dark:text-gray-400 font-semibold">Rs.</span>
                                </div>
                                <input type="number" step="0.01" min="0" name="return_fee" id="return_fee" value="{{ old('return_fee', $reseller->return_fee ?? 0) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-12 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                            </div>
