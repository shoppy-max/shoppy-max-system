    ...
    private function seedOrders(
        ...
        $rows = [
            ...
            [
                ...
                'courier_charge' => 400.00,
                'courier_cost' => 0.00,
                'sales_note' => 'Waybill queue demo order 2',
                'items' => [
                    ['sku' => 'HSH-250ML', 'quantity' => 2, 'selling_price' => 1180.00],
            ...
            [
                ...
                'courier_charge' => 400.00,
                'courier_cost' => 0.00,
                'sales_note' => 'Waybill queue demo order 3',
                'items' => [
                    ['sku' => 'FDOJ-1L', 'quantity' => 2, 'selling_price' => 760.00],
                    ['sku' => 'VLC-1M', 'quantity' => 1, 'selling_price' => 1250.00],
                ],
            ...
            [
                ...
                'courier_charge' => 400.00,
                'courier_cost' => 0.00,
                'sales_note' => 'Waybill queue demo order 4',
                'items' => [
                    ['sku' => 'PNR-1KG', 'quantity' => 3, 'selling_price' => 310.00],
                    ['sku' => 'HSH-250ML', 'quantity' => 1, 'selling_price' => 1180.00],
                ],
            ],
            [
                'order_number' => 'DEMO-ORD-0013',
                'order_date' => now()->toDateString(),
                'order_type' => 'direct',
                'status' => 'confirm',
                'call_status' => 'confirm',
                ...
                'courier_charge' => 400.00,
                'courier_cost' => 0.00,
                'sales_note' => 'Waybill queue demo order 5',
                'items' => [
                    ['sku' => 'VLC-1M', 'quantity' => 1, 'selling_price' => 1250.00],
